...
tag3 : Invoice date & time stamp
tag4 : Total invoice amount including VAT, preferred to be 2 decimal digits as they do in thier example
tag5 : Tax amount, preferred to be 2 decimal digits as they do in thier example
...
l_qr_hex := to_char(1,'0x')||to_char(l_tag1_len,'0x')||l_tag1||
            to_char(2,'0x')||to_char(l_tag2_len,'0x')||l_tag2||
            to_char(3,'0x')||to_char(l_tag3_len,'0x')||l_tag3||
            to_char(4,'0x')||to_char(l_tag4_len,'0x')||l_tag4||
            to_char(5,'0x')||to_char(l_tag5_len,'0x')||l_tag5;
